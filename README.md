...
This application was 100% built with agentic AI.  Other than directing the agents and reviewing the code, I did not write any of the components of this application.  Do not expose this to the internet. Do not run this in production environments.  There is no gaurantee of appropriate security controls, critical stability bugs, or general functionality.  This application was built using OpenAI Codex version 26.

# License
Because this application is completed AI generated, it is released as Unlicensed.

To the extent any copyrightable interest exists in the human operator’s selection, prompts, review, arrangement, curation, documentation, repository structure, or other contributions, those interests are dedicated to the public domain or released under The Unlicense.

To the extent any portion of this project is not copyrightable because it was generated by AI without sufficient human authorship, no ownership claim is made over that material.
